...
INST_LOG="/mnt/us/KindleRunner_install.log"
...
logmsg "I" "copy" "Installing KindleRunner..."
cp -f KindleRunner-2.7.azw2 /mnt/us/documents/KindleRunner-2.7.azw2 2>> ${INST_LOG}
logmsg "I" "copy" "Success."
